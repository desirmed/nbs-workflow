...
**For this tutorial, this concludes the coverage of functions in R. If you would like to explore additional functions, examples, or need clarification on any of the steps covered, please visit the GitHub repository: [nbs-workflow](https://github.com/deltares-desirmed/nbs-workflow) and feel free to open an issue.**
