---
title: "Downloads and Geoprocessing"
...
In this tutorial, I am using a .gpkg file which is made available on GitHub. You can download it by clicking [this link](https://github.com/deltares-desirmed/nbs-workflow/raw/refs/heads/master/data/vector/kanchanpur.gpkg).
...
To load raster data using **terra**, you use the _rast()_ function. In this tutorial, I am using .tif files which are available on GitHub. You can download it by clicking here: [Land Cover 2015](https://github.com/deltares-desirmed/nbs-workflow/raw/refs/heads/master/data/raster/landcover_2015.tif) & [Land Cover 2019](https://github.com/deltares-desirmed/nbs-workflow/raw/refs/heads/master/data/raster/landcover_2019.tif).
